...
import os
import torch
from repr_conversion.simplify_loc2rot import joints2smpl
...
class npy2obj:
    def __init__(self, npy_path, sample_idx, rep_idx, device=0, cuda=True):
        ...
        if self.nfeats == 3:
            ...
            # print(self.motions['motion'][self.absl_idx].transpose(2, 0, 1).shape), 75, 21, 3
    ...
    def save_motion(self, save_path):
        ...
        print('saving motion')
        np.save(save_path, self.motions['motion'][0, :, :, :self.real_num_frames])